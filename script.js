...
document.querySelector('.resume-download .btn').addEventListener('click', (e) => {
    e.preventDefault();
    // You can replace this with actual resume download logic
    alert('Resume download functionality - replace with actual PDF download');
});
...
document.querySelectorAll('.social-link').forEach(link => {
    link.addEventListener('click', (e) => {
        ...
        if (platform.includes('github')) {
            url = 'https://github.com/jasvant';
        } else if (platform.includes('linkedin')) {
            url = 'https://www.linkedin.com/in/jasvant-chandel-a4aaa4276/';
        } else if (platform.includes('twitter')) {
            url = 'https://twitter.com/jasvant';
        } else if (platform.includes('instagram')) {
            url = 'https://instagram.com/jasvant';
        }
